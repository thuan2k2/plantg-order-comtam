...
import UserSettings from './pages/UserSettings'; // TRANG MỚI: Cài đặt khách
...
import AdminSettings from './pages/Admin/AdminSettings'; // TRANG MỚI: Cài đặt hệ thống
import InitializeSystem from './pages/Admin/InitializeSystem'; // TRANG MỚI: Script khởi tạo Bước 1
    ...
    <SettingsProvider>
      <Router>
        <div className="app-container dark:bg-gray-900 transition-colors duration-300 min-h-screen">
          <Routes>
            {/* --- ROUTE KHỞI TẠO HỆ THỐNG (Chạy 1 lần duy nhất) --- */}
            ...
            <Route path="/settings" element={<UserSettings />} /> {/* Route mới: Cài đặt cá nhân */}
            ...
            >
              ...
              <Route path="settings" element={<AdminSettings />} /> {/* Route mới: Cấu hình hệ thống */}
            </Route>
