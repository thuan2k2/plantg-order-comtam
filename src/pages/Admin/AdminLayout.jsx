...
const AdminLayout = () => {
  ...
  const menuItems = [
    ...
    // --- BỔ SUNG: TRANG QUẢN LÝ TẤT CẢ ĐƠN HÀNG (XÓA VĨNH VIỄN) ---
    { path: '/admin/all-orders', label: 'Quản lý đơn tổng', icon: (
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <h1 className="text-xs sm:text-sm font-black text-gray-800 uppercase tracking-tighter truncate max-w-[150px] sm:max-w-[300px]">
                ...
                {isActive('/admin/all-orders') && 'Quản lý toàn bộ đơn hàng'}
